    ...
    <Row>
      <Col className='bookstore-column' span={24}>
        ...
        <div className='bookstore-admin-module-container'>
          <div className='bookstore-admin-module' onClick={() => goTo('/admin/manage/books')}>
            <BookOutlined className='bookstore-admin-module-icon' />
            <Title className='bookstore-admin-module-title'>Manage<br />Books</Title>
          </div>
          <div className='bookstore-admin-module' onClick={() => goTo('/admin/manage/users')}>
            <UserOutlined className='bookstore-admin-module-icon' />
            <Title className='bookstore-admin-module-title'>Manage<br />Users</Title>
          </div>
          <div className='bookstore-admin-module' onClick={() => goTo('/admin/manage/promotions')}>
