...
import { Layout, Menu, Typography, Input , Card, Space, Button, Form, Select, Table, notification} from 'antd';

import { UserOutlined, KeyOutlined, CreditCardOutlined, EyeInvisibleOutlined, EyeTwoTone} from '@ant-design/icons';
            ...
            <Card bordered={false}>
              <Form>
                <Space direction = "vertical">
                  ...
                  <Button type="primary" onClick = {paymentNotification}>Add Card</Button>
                </Space>
      ...
      return(
        <Card title="Change Password">
          ...
          <Space style={{ marginTop: 16 }}>
            <Button type="primary" htmlType="submit" onClick = {passwordNotification}>Change Password </Button>
          </Space>
        </Card>
      );
    case '3':
        ...
        <Card title="Address">
          ...
          >  
            <Form.Item label="Street Address" >
              <Input defaultValue= "1005 Macon Hwy" placeholder="input placeholder" />
            </Form.Item>
            ...
            <Form.Item>
              <Space direction="horizontal">
                <Form.Item label="City">
                  <Input defaultValue="Athens" placeholder="input placeholder" />
                </Form.Item>  
            ...
            <Form.Item>
              <Space direction="horizontal">
                <Form.Item label="Postal/ZipCode">
                  <Input defaultValue="30606" placeholder="input placeholder" />
                </Form.Item>  
                <Form.Item label="Country">
                  <Select placeholder="Select province" defaultValue="United States of America">
            ...
            <Form.Item>
              <Button type="primary" onClick = {addressNotification}>Update Address</Button>
            </Form.Item>
          </Form>
        </Card>
      );
        ...
        <Layout>
          <Sider width={200} className="site-layout-background">
            <Menu
              ...
              onClick={(e) => 
                       setSelectedMenuItem1(e.key)}
            >
              <Menu.Item key="1" icon={<UserOutlined />}>Personal Information</Menu.Item>
              <Menu.Item key="2" icon={<KeyOutlined />}>Security</Menu.Item>
              <SubMenu key="sub1" icon={<CreditCardOutlined />} title="Payment Info">
  ...
  return(
    <Layout>
      <Header className="header">
        <Menu mode="horizontal" defaultSelectedKeys={['1']} onClick={(e) => 
                                                                     setSelectedMenuItem(e.key)} className="profile-nav">
